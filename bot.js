...
async function generateTweet(newsText) {
    try {
        const response = await axios.post(
            ...
            {
                contents: [{ parts: [{ text: `Summarize this for Twitter. Do this in crisp and human tone. add hastag according to trend so that it come in trend: ${newsText}. write it in hinglish. give news related to technology` }] }]
            }
        );
